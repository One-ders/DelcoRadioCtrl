...
#define VF_STROBE_PIN	GPIO_PIN(GPIO_PA,4)
#define CLK_PIN		GPIO_PIN(GPIO_PA,5)
#define SYN_STROBE_PIN  GPIO_PIN(GPIO_PA,6)
#define DATA_PIN	GPIO_PIN(GPIO_PA,7)

#define TUNE_WHEEL_1	GPIO_PIN(GPIO_PB,0)
#define TUNE_WHEEL_2	GPIO_PIN(GPIO_PB,1)
#define TUNE_WHEEL_3	GPIO_PIN(GPIO_PB,2)
